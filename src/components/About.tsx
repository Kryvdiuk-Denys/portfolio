        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              Мій шлях почався з труднощів: спочатку курси, далі — вступ до ЧНУ,
              а зараз я вже рухаюся в сторону майбутнього, яке пов’язане з
              розробкою сучасних продуктів.
            </p>
            <p className="text-gray-400 leading-relaxed mb-4">
              Я вчуся створювати вебзастосунки, працювати з React, TypeScript,
              UI/UX і розуміти, як перетворювати ідеї на реальні рішення.
            </p>
            <p className="text-gray-400 leading-relaxed">
              Моя мета — не просто вивчати технології, а будувати справжні
              проєкти, розвиватися як Full Stack Developer і створювати те, що
              буде корисним людям.
            </p>
          </motion.div>
        </div>
